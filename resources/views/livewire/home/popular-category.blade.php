@if ($popular_categories->count())
    <div class="row">
        <div class="col-md-12 col-sm-2 col-xl-12 mt-5">
            <h2 class="title title-border">Birds Popular Categories</h2>
            <!-- End .title -->
            {{-- owl-simple  --}}
                ...
                @foreach ($popular_categories as $popular_category)
                    <div class="product shadow">
                        <figure class="product-media">
                            ...
                            <a href="{{ route('frontend.view-category', ['slug' => $popular_category->slug]) }}">
                                <img style="
                                  width: 300px;height: 200px;"
                                    class="product-image img-fluid" src="{{ asset($popular_category->image) }}"
                                    alt="Birds image" class="product-image">
                            </a>
                            <div class="product-action">
                                <a href="{{ route('frontend.view-category', ['slug' => $popular_category->slug]) }}"class="btn-product "
                                    title="Browse">
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title">{{ $popular_category->name }}</h3>
                            <!-- End .product-title -->
