                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <div class="py-4">
                                    ...
                                    <p class="clearfix">
                                        <span class="float-left">Buyer Name</span>
                                        <span class="float-right text-muted ">
                                            @if ($order->user)
                                                <span class="text-success"> {{ $order->user->name }}</span>
                                            @else
                                                <span class="text-success"> {{ $order->user_name }}</span>
                                            @endif
                                        </span>
                                    </p>

                                    <p class="clearfix">
                                        <span class="float-left">Buyer Phone</span>
                                        <span class="float-right text-muted ">
                                            <span class="text-success"> {{ $order->user_phone }}</span>
                                        </span>
                                    </p>


                                    <p class="clearfix">
                                        <span class="float-left">Buyer Email</span>
                                        <span class="float-right text-muted ">
                                            <span class="text-success"> {{ $order->user_email }}</span>
                                        </span>
                                    </p>
                                    ...
                                    <p class="clearfix">
                                        <span class="float-left">Buyer Shipping Address</span>
                                        <span class="float-right text-muted ">
                            ...
                            <div class="col-lg-9 pl-lg-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-description">{{ $order->created_at->diffForHumans() }}</p>
                                        <div class="mt-4">
