        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="cmxform" id="crud" method="post" action="{{ route('product.add') }}"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    ...
                                    <input id="name" value="{{ old('name') }}" class="form-control form-control-sm"
                                        maxlength="40" name="name" type="text">
                                </div>
                                <div class="col-sm-3">
